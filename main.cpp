...
int main() {
    ...
    cout << "The price of the call is equal to "<< price_call_mc << endl;
    double price_call_bs = bs.CalculPrice();
    cout << "The price of the call is equal to "<< price_call_bs << endl;
    // delta
    double delta_mc = mc.CalculDelta(call, 1000000, 0.5);
    cout << "The delta is equal to "<< delta_mc << endl;
    double delta_bs = bs.CalculDelta();
    cout << "The delta is equal to "<< delta_bs << endl;
    // gamma
    double gamma_mc = mc.CalculGamma(call, 1000000, 0.001);
    cout << "The gamma is equal to "<< gamma_mc << endl;
    double gamma_bs = bs.CalculGamma();
    cout << "The gamma is equal to "<< gamma_bs << endl;
    // vega
